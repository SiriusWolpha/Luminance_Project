...
- {pin_num: '16', pin_signal: GPIO_EMC_02, label: 'SEMC_D2/U14[5]', identifier: SEMC_D2;SCL}
- {pin_num: '15', pin_signal: GPIO_EMC_03, label: 'SEMC_D3/U14[7]', identifier: SEMC_D3;SDA}
...
- {pin_num: '126', pin_signal: GPIO_EMC_30, label: 'SEMC_CLK/U14[38]', identifier: SEMC_CLK;S_PENIRQ}
- {pin_num: '125', pin_signal: GPIO_EMC_31, label: 'SEMC_DM1/U14[39]', identifier: SEMC_DM1;S_LED}
- {pin_num: '124', pin_signal: GPIO_EMC_32, label: 'SEMC_D8/U14[42]', identifier: SEMC_D8;S_CLK}
...
- {pin_num: '120', pin_signal: GPIO_EMC_36, label: 'SEMC_D12/U14[48]', identifier: SEMC_D12;S_DC}
- {pin_num: '119', pin_signal: GPIO_EMC_37, label: 'SEMC_D13/U14[50]', identifier: SEMC_D13;S_TOUCH_CS}
- {pin_num: '118', pin_signal: GPIO_EMC_38, label: 'SEMC_D14/U14[51]', identifier: SEMC_D14}
- {pin_num: '117', pin_signal: GPIO_EMC_39, label: 'SEMC_D15/U14[53]', identifier: SEMC_D15;S_RESET}
...
- {pin_num: '98', pin_signal: GPIO_AD_B0_10, label: 'ENET_RXD0/U11[16]/J19[6]', identifier: ENET_RXD0;MyLED_R}
...
- {pin_num: '94', pin_signal: GPIO_AD_B0_14, label: 'ENET_TXD0/U11[24]/J17[7]', identifier: ENET_TXD0;MyLED_G}
- {pin_num: '93', pin_signal: GPIO_AD_B0_15, label: 'ENET_TXD1/U11[25]/J19[2]', identifier: ENET_TXD1;MyLED_B}
...
- {pin_num: '19', pin_signal: GPIO_SD_B1_11, label: 'FlexSPI_SS0/U13[1]', identifier: FlexSPI_SS0;S_LED}
...
- pin_list:
  ...
  - {pin_num: '120', peripheral: GPIO3, signal: 'gpio_io, 04', pin_signal: GPIO_EMC_36, identifier: S_DC, direction: OUTPUT, gpio_init_state: 'true'}
  - {pin_num: '117', peripheral: GPIO3, signal: 'gpio_io, 07', pin_signal: GPIO_EMC_39, identifier: S_RESET, direction: OUTPUT, gpio_init_state: 'true'}
  ...
  - {pin_num: '126', peripheral: GPIO2, signal: 'gpio_io, 30', pin_signal: GPIO_EMC_30, identifier: S_PENIRQ, direction: INPUT, gpio_interrupt: kGPIO_IntFallingEdge}
  - {pin_num: '119', peripheral: LPSPI4, signal: PCS2, pin_signal: GPIO_EMC_37, identifier: S_TOUCH_CS, direction: OUTPUT}
  - {pin_num: '125', peripheral: GPIO2, signal: 'gpio_io, 31', pin_signal: GPIO_EMC_31, identifier: S_LED, direction: OUTPUT, gpio_init_state: 'false'}
  - {pin_num: '15', peripheral: GPIO2, signal: 'gpio_io, 03', pin_signal: GPIO_EMC_03, identifier: SDA, direction: OUTPUT, gpio_init_state: 'true', software_input_on: Enable}
  - {pin_num: '16', peripheral: GPIO2, signal: 'gpio_io, 02', pin_signal: GPIO_EMC_02, identifier: SCL, direction: OUTPUT, gpio_init_state: 'true', software_input_on: Enable}
  - {pin_num: '18', peripheral: GPIO2, signal: 'gpio_io, 00', pin_signal: GPIO_EMC_00, direction: OUTPUT, gpio_init_state: 'true'}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
void BOARD_InitPins(void) {
  ...
  /* GPIO configuration of SEMC_D0 on GPIO_EMC_00 (pin 18) */
  ...
  GPIO_PinInit(GPIO2, 0U, &SEMC_D0_config);

  /* GPIO configuration of SCL on GPIO_EMC_02 (pin 16) */
  ...
  GPIO_PinInit(GPIO2, 2U, &SCL_config);

  /* GPIO configuration of SDA on GPIO_EMC_03 (pin 15) */
  ...
  GPIO_PinInit(GPIO2, 3U, &SDA_config);

  /* GPIO configuration of S_PENIRQ on GPIO_EMC_30 (pin 126) */
  gpio_pin_config_t S_PENIRQ_config = {
      .direction = kGPIO_DigitalInput,
      .outputLogic = 0U,
      .interruptMode = kGPIO_IntFallingEdge
  };
  /* Initialize GPIO functionality on GPIO_EMC_30 (pin 126) */
  GPIO_PinInit(GPIO2, 30U, &S_PENIRQ_config);
  /* Enable GPIO pin interrupt on GPIO_EMC_30 (pin 126) */
  GPIO_PortEnableInterrupts(GPIO2, 1U << 30U);

  /* GPIO configuration of S_LED on GPIO_EMC_31 (pin 125) */
  gpio_pin_config_t S_LED_config = {
      .direction = kGPIO_DigitalOutput,
      .outputLogic = 0U,
      .interruptMode = kGPIO_NoIntmode
  };
  /* Initialize GPIO functionality on GPIO_EMC_31 (pin 125) */
  GPIO_PinInit(GPIO2, 31U, &S_LED_config);

  /* GPIO configuration of S_DC on GPIO_EMC_36 (pin 120) */
  gpio_pin_config_t S_DC_config = {
      .direction = kGPIO_DigitalOutput,
      .outputLogic = 1U,
      .interruptMode = kGPIO_NoIntmode
  };
  /* Initialize GPIO functionality on GPIO_EMC_36 (pin 120) */
  GPIO_PinInit(GPIO3, 4U, &S_DC_config);

  /* GPIO configuration of S_RESET on GPIO_EMC_39 (pin 117) */
  gpio_pin_config_t S_RESET_config = {
      .direction = kGPIO_DigitalOutput,
      .outputLogic = 1U,
      .interruptMode = kGPIO_NoIntmode
  };
  /* Initialize GPIO functionality on GPIO_EMC_39 (pin 117) */
  GPIO_PinInit(GPIO3, 7U, &S_RESET_config);
  ...
  IOMUXC_SetPinMux(IOMUXC_GPIO_EMC_02_GPIO2_IO02, 1U); 
  IOMUXC_SetPinMux(IOMUXC_GPIO_EMC_03_GPIO2_IO03, 1U); 
...
- options: {callFromInitBoot: 'true', coreID: core0, enableClock: 'true'}
- pin_list:
  - {pin_num: '93', peripheral: GPIO1, signal: 'gpio_io, 15', pin_signal: GPIO_AD_B0_15, identifier: MyLED_B, direction: OUTPUT, gpio_init_state: 'true'}
  - {pin_num: '94', peripheral: GPIO1, signal: 'gpio_io, 14', pin_signal: GPIO_AD_B0_14, identifier: MyLED_G, direction: OUTPUT, gpio_init_state: 'true'}
  - {pin_num: '98', peripheral: GPIO1, signal: 'gpio_io, 10', pin_signal: GPIO_AD_B0_10, identifier: MyLED_R, direction: OUTPUT, gpio_init_state: 'true'}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
void BOARD_InitDEBUG_UARTPins(void) {
  ...
  /* GPIO configuration of MyLED_R on GPIO_AD_B0_10 (pin 98) */
  gpio_pin_config_t MyLED_R_config = {
      .direction = kGPIO_DigitalOutput,
      .outputLogic = 1U,
      .interruptMode = kGPIO_NoIntmode
  };
  /* Initialize GPIO functionality on GPIO_AD_B0_10 (pin 98) */
  GPIO_PinInit(GPIO1, 10U, &MyLED_R_config);

  /* GPIO configuration of MyLED_G on GPIO_AD_B0_14 (pin 94) */
  gpio_pin_config_t MyLED_G_config = {
      .direction = kGPIO_DigitalOutput,
      .outputLogic = 1U,
      .interruptMode = kGPIO_NoIntmode
  };
  /* Initialize GPIO functionality on GPIO_AD_B0_14 (pin 94) */
  GPIO_PinInit(GPIO1, 14U, &MyLED_G_config);

  /* GPIO configuration of MyLED_B on GPIO_AD_B0_15 (pin 93) */
  gpio_pin_config_t MyLED_B_config = {
      .direction = kGPIO_DigitalOutput,
      .outputLogic = 1U,
      .interruptMode = kGPIO_NoIntmode
  };
  /* Initialize GPIO functionality on GPIO_AD_B0_15 (pin 93) */
  GPIO_PinInit(GPIO1, 15U, &MyLED_B_config);
...
- pin_list:
  ...
  - {pin_num: '126', peripheral: SEMC, signal: semc_clk, pin_signal: GPIO_EMC_30, identifier: SEMC_CLK}
  ...
  - {pin_num: '125', peripheral: SEMC, signal: 'DM, 1', pin_signal: GPIO_EMC_31, identifier: SEMC_DM1}
  - {pin_num: '9', peripheral: SEMC, signal: 'DM, 0', pin_signal: GPIO_EMC_08}
  - {pin_num: '117', peripheral: SEMC, signal: 'DATA, 15', pin_signal: GPIO_EMC_39, identifier: SEMC_D15}
  - {pin_num: '118', peripheral: SEMC, signal: 'DATA, 14', pin_signal: GPIO_EMC_38}
  - {pin_num: '119', peripheral: SEMC, signal: 'DATA, 13', pin_signal: GPIO_EMC_37, identifier: SEMC_D13}
  - {pin_num: '120', peripheral: SEMC, signal: 'DATA, 12', pin_signal: GPIO_EMC_36, identifier: SEMC_D12}
...
- pin_list:
  ...
  - {pin_num: '93', peripheral: ENET, signal: 'enet_tx_data, 1', pin_signal: GPIO_AD_B0_15, identifier: ENET_TXD1}
  - {pin_num: '94', peripheral: ENET, signal: 'enet_tx_data, 0', pin_signal: GPIO_AD_B0_14, identifier: ENET_TXD0}
  ...
  - {pin_num: '98', peripheral: ENET, signal: 'enet_rx_data, 0', pin_signal: GPIO_AD_B0_10, identifier: ENET_RXD0}
...
- pin_list:
  ...
  - {pin_num: '19', peripheral: FLEXSPI, signal: FLEXSPI_A_SS0_B, pin_signal: GPIO_SD_B1_11, identifier: FlexSPI_SS0}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
